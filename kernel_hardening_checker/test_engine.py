...
'               ]
    ...
    def test_complex_value_overriding(self) -> None:
        ...
        override_expected_value(config_checklist, 'CONFIG_NAME_1', 'expected_1') # rever the value back to check if we could ovveride second one
        override_expected_value(config_checklist, 'CONFIG_NAME_2', 'expected_2_new')
        perform_checks(config_checklist)
        ...
        self.assertEqual(
                result,
                [{'option_name': 'CONFIG_NAME_1', 'type': 'kconfig', 'reason': 'reason_1', 'decision': 'decision_1', 'desired_val': 'expected_1', 'check_result': 'OK: CONFIG_NAME_2 is "expected_2_new"', 'check_result_bool': True},
                 {'option_name': 'CONFIG_NAME_3', 'type': 'kconfig', 'reason': 'reason_3', 'decision': 'decision_3', 'desired_val': 'expected_3', 'check_result': 'FAIL: CONFIG_NAME_4 is not "expected_4"', 'check_result_bool': False}]
        )
        # 10. override expected value and perform the checks again
        ...
        # 11. check that the results are correct
        result = []
        self.get_engine_result(config_checklist, result, 'json')
        self.assertEqual(
                result,
